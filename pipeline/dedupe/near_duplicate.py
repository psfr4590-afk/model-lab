...
class SemanticDeduplicator:
    ...
    def _fallback_similarity(a: str, b: str) -> float:
        """Dependency-free token-set similarity used when embeddings are unavailable."""
    ...
    def _fallback_run(self, docs: list[Document]) -> list[Document]:
        ...
        log.warning("Semantic dedup fallback active: embeddings unavailable; using local token-gram similarity")
        return kept
